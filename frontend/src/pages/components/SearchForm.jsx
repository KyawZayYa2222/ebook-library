...
export default function SearchForm() {
  ...
  return (
    <div className="relative max-w-3xl w-full">
      <form onSubmit={handleSearchForm} className="flex items-center border border-gray-400 rounded-lg overflow-hidden shadow-md shadow-gray-200">
          <input
          type="text"
          placeholder="Search..."
      ...
      {/* optional feature  */}
      {/* <div className="absolute mt-2 z-20 bg-yellow-400 w-full">hello</div> */}
    </div>
  )
}
